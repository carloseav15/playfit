...
const SCRAPE_FILE = new URL("../reports/gamesdatabase-ps2.json", import.meta.url);
const PS2_TSV = "/tmp/ps2_games.tsv";
const OUT_FILE = new URL("../reports/gamesdatabase-ps2-apply.json", import.meta.url);
