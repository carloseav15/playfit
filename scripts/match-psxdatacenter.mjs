// Matches the psxdatacenter.com NTSC-U scrape (reports/psxdatacenter-ntscu.json)
...
const SCRAPE_FILE = new URL("../reports/psxdatacenter-ntscu.json", import.meta.url);
const PS2_TSV = "/private/tmp/claude-501/-Users-carancibia-Projects-playfit/1d7a580e-06e2-486a-bb08-4bee589bdee0/scratchpad/ps2_games.tsv";
const OUT_FILE = new URL("../reports/psxdatacenter-apply.json", import.meta.url);
...
const ALL_GENRE_IDS = new Set([
  ...
  "board-games", "card", "card_horror_adventure", "card_rpg", "casual",
  ...
  "lore_film", "massively_multiplayer", "massively-multiplayer", "metroidvania",
  ...
  "roguelite_card_game", "role_playing_games_rpg", "role-playing-games-rpg", "rpg",
...
function main() {
  ...
  const ps2Rows = readFileSync(PS2_TSV, "utf8")
    .split("\n")
    .filter(Boolean)
    .map((line) => {
